...
return [
    ...
    */
    ...
    'availability_rejection' => [
        ...
        'needs_adult' => ['label' => 'Σε αυτή την εκδρομή τα παιδιά ταξιδεύουν με συνοδό ενήλικα. Προσθέστε έναν ενήλικα στην κράτηση.'],
        'too_few_pax' => [
            'label' => 'Πολύ λίγα άτομα για μία κράτηση σε αυτή την εκδρομή.',
            'sentence' => '{1} Η εκδρομή κλείνεται για τουλάχιστον :count άτομο.|[2,*] Η εκδρομή κλείνεται για τουλάχιστον :count άτομα.',
        ],
        'too_many_pax' => [
            'label' => 'Πολλά άτομα για μία κράτηση σε αυτή την εκδρομή.',
            'sentence' => '{1} Η εκδρομή δέχεται έως :count άτομο ανά κράτηση.|[2,*] Η εκδρομή δέχεται έως :count άτομα ανά κράτηση.',
        ],
    ...
    'home_block_type' => [
        ...
        'stats' => [
            'label' => 'Αριθμοί',
            'description' => 'Έως τέσσερις αριθμοί με μια λέξη ο καθένας, σε κάρτα κάτω από την επικεφαλίδα.',
        ],
        'steps' => [
            'label' => 'Πώς λειτουργεί',
            'description' => 'Τα βήματα από την επιλογή της εκδρομής μέχρι την επιβίβαση, αριθμημένα.',
        ],
        'features' => [
            'label' => 'Γιατί εμάς',
            'description' => 'Έως τέσσερις λόγοι να σας διαλέξουν, ο καθένας με εικονίδιο.',
        ],
        'testimonials' => [
            'label' => 'Κριτικές',
            'description' => 'Έως τρεις κριτικές επισκεπτών, με αστέρια.',
        ],
        'cta' => [
            'label' => 'Κάλεσμα',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Το «GetYourGuide» είναι εμπορικό σήμα και μένει στα λατινικά, όπως και οι
    | πάροχοι παραπάνω. Το iCal όμως δεν είναι μάρκα αλλά μορφή αρχείου, και ο
    | διοργανωτής το συναντά ως «ημερολόγιο» — η οθόνη του το λέει έτσι ήδη.
    */
    'channel_key' => [
        'ical' => ['label' => 'Ημερολόγιο iCal'],
        'getyourguide' => ['label' => 'GetYourGuide'],
    ],
