...
return [
    ...
    'remove_guests' => [
        ...
        'who' => 'Who is not coming',
        'who_help' => 'Tick the people coming off. Anybody already checked in is not listed.',
        'passenger' => 'Passenger :position',
        'done_split' => ':refund refunded to the card and :voucher back to the voucher.',
        'done_voucher' => ':voucher went back to the voucher.',
