...
return [
    ...
    'product' => [
        ...
        // «At least N people» (2026-09-25): per seat only, and only above one.
    ...
    // «Calendar» (2026-09-25): every departure, day by day.
    'calendar' => [
        'nav' => 'Calendar',
        'title' => 'Calendar',
        'eyebrow' => 'Every departure',
        'lede' => 'See the schedule and find the trip that suits you.',
        'meta' => 'Every departure of :operator, day by day, with seats and prices.',
        'days' => 'Days',
        ...
        'filters' => 'Filters',
        'filters_summary' => '{1} Filters · 1 person|[2,*] Filters · :count people',
        'pax' => 'People',
        'pax_value' => '{1} 1 person|[2,*] :count people',
        'fewer' => 'Fewer people',
        'more' => 'More people',
        'part' => 'Time of day',
        'parts' => [
        ...
        'trips' => 'Trip',
        'only_free' => 'Only with free seats',
        'clear' => 'Clear filters',
        'count' => '{1} 1 departure|[2,*] :count departures',
        'empty_day' => 'We have no departures this day.',
        'empty_day_filtered' => 'No departures match these filters.',
        'all_day' => 'All day',
        'whole_boat' => 'The whole boat',
        'per_person' => 'per person',
        'per_boat' => 'per boat',
        'book' => 'Book',
        'see_trip' => 'See the trip',
        'status' => [
            'available' => 'Available',
            'few' => '{1} Last seat|[2,*] Last :count seats',
            'no_fit' => '{1} Only 1 seat|[2,*] Only :count seats',
            'too_many' => 'Up to :count people',
            'too_few' => 'From :count people',
            'full' => 'Full',
            'booked' => 'Booked',
            'free_boat' => 'Boat free',
            'cancelled' => 'Cancelled',
        ...
        'weather' => [
            'all' => 'No sailing: the weather',
            'all_body' => 'This day\'s departures are cancelled.',
            'some' => 'Some departures cancelled for weather',
            'some_body' => 'The others sail as planned.',
        ],
        'empty_filtered' => [
            'heading' => 'No departures match these filters, :range',
            'body' => 'Try fewer people, another time of day or another trip.',
        ],
        'closed' => [
            'heading' => 'No departures, :range',
            'next' => 'The next departure is on :date.',
            'next_button' => 'Next: :date',
            'none' => 'We have no departures scheduled yet. For a private trip, ask us.',
        ],
    ],
