...
return [
    ...
    'checkout' => [
        ...
        'passengers_why' => 'The coastguard asks for a passenger list on this trip. Only the operator sees these details, and they are deleted after the trip.',
        ...
        'no_document' => 'No document is needed for this passenger.',
        'passenger_field' => 'Passenger :n, :field',
        ...
        'errors' => [
            ...
            'expired' => 'Passenger :n: the passport expires before the trip.',
            'age_range' => 'Passenger :n: the date of birth does not match «:band» (:min to :max years old on the day of the trip).',
            'age_from' => 'Passenger :n: the date of birth does not match «:band» (:min years or older on the day of the trip).',
        ],
