...
return [
     ...
     */
    /*
    | The public API and nothing else. `/app` and `/admin` are Sanctum-session
    | back-office surfaces and are explicitly NOT part of this document
    | (docs/api.md §5 info.description) — generating them would put operator
    | routes into a contract meant for integrators.
    */
    'api_path' => 'api/v1',
     ...
     */
    /*
    | Written under build/, which is gitignored. The generated document is an
    | artefact for the drift gate to compare against and is never committed —
    | a generated file sitting beside docs/api.md is how someone eventually
    | edits the wrong one, or regenerates the contract from the code.
    */
    'export_path' => 'build/openapi.generated.json',
    ...
    'info' => [
         ...
         * API version.
         */
        // Pinned, not env-driven. §1.3 makes the version part of the contract
        // and it is already in the URL prefix; an environment variable able to
        // change it would let staging and production claim different versions
        // of the same API.
        'version' => '1.0.0',
         ...
         */
        'description' => 'Generated from the routes. The contract is docs/api.md §5 — '
            . 'the direction of authority runs contract to code, never the reverse (§10.5).',
    ],
