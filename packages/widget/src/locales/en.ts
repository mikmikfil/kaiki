...
export const en = {
  ...
  'booking.lines.hour_one': '1 hour',
  'booking.lines.hours': ':hours hours',
  'booking.lines.hour_one_minutes': '1 hour :minutes minutes',
  'booking.lines.hours_minutes': ':hours hours :minutes minutes',
  ...
  'booking.date.guaranteed': 'Guaranteed',
  'booking.party.heading': 'How many of you?',
  'booking.party.more': 'One more',
  'booking.party.fewer': 'One fewer',
  'booking.party.change': 'Change',
  ...
  // The label a booking embed shows when its trip turns out to be sold by
  // quote (BKG-24): the form stands where the calendar would have been.
  'enquiry.on_request': 'On request',
  ...
  'enquiry.submit': 'Send your question →',
  'enquiry.sub': 'Two steps, one minute.',
  'enquiry.date': 'Date',
  'enquiry.people': 'People',
  'enquiry.fewer': 'Fewer people',
  'enquiry.more_people': 'More people',
  'enquiry.more': 'Anything else?',
  'enquiry.optional': '(optional)',
  'enquiry.more_placeholder': 'A birthday, a proposal, where you would like to go…',
  'enquiry.note': 'No commitment. We answer within the day.',
  'enquiry.auto_message': 'Question about the trip: :date, :pax people.',
  'enquiry.auto_any_date': 'any day',
